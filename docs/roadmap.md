...
- [x] multi-depth hidden-state MSE and cosine similarity: track at several trunk depths (not only depth k)
- [x] add cosine similarity, logit KL, and top-k metrics directly in the training validation loop
