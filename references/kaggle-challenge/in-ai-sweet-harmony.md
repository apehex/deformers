---
title: "In AI Sweet Harmony: Guardrail Bypasses and Evaluation‑Aware Behavior in gpt‑oss"
source: "https://www.kaggle.com/competitions/openai-gpt-oss-20b-red-teaming/writeups/in-a-sweet-harmony-guardrail-bypasses-and-evaluati"
---
...
The linked Github repository contains the same files as attached to this Writeup, plus supplementary materials like helper scripts. Last commit as of the submission to the contest: 57d5d3361f26ed6efb175a905bb882e66eec1a17
...
*   Prior art and inspiration: We partially build directly on the “Gaybreaking” line of work. Thanks to [@Exocija](https://www.kaggle.com/Exocija) on X for publishing “The Gay Jailbreak” guide and examples (ZetaLib), and to Richa Sharma (@richa_lq on X) for the AGI House SF demo and public prompts illustrating queer‑coded and Gen‑Z register effects. These artifacts motivated exploring the sociopragmatic framing and several of our prompt families.
