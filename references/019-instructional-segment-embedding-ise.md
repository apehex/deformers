...
Source: https://proceedings.iclr.cc/paper_files/paper/2025/file/ea13534ee239bb3977795b8cc855bacc-Paper-Conference.pdf
Source type: pdf
...
LLM SAFETY WITH INSTRUCTION HIERARCHY
Tong Wu1∗
Shujian Zhang2 Kaiqiang Song2 Silei Xu2 Sanqiang Zhao2 Ravi Agrawal2
...
2
BACKGROUND: LLM VULNERABILITIES
...
3
LACK OF INSTRUCTION HIERARCHY IN MODERN LLM ARCHITECTURE
...
4
PROPOSED APPROACH: INSTRUCTIONAL SEGMENT EMBEDDING (ISE)
...
Published as a conference paper at ICLR 2025
#1: Indirect Prompt Injection (ID) 
#2: Indirect Prompt Injection (OOD) 
#3: Direct Prompt Injection (ID) 
#4: Direct Prompt Injection (OOD) 
#5: Prompt Extraction (ShareGPT)
#6: Prompt Extraction (Unnatural)
#7: Harmful Requests (Chat) 
#8: Harmful Requests (DAN) 
AlpacaEval 
MT-Bench 
UltraChat Baseline
System Follow 
...
Figure 8:
Harmful re-
quests across categories
using UltraChat Baseline.
UltraChat
Baseline
System
Follow
...
Baseline
+ISE (Ours)
Figure 10: Evaluation of Llama-3.1-
...
Abacus.AI.
Systemchat-1.1, 2023.
URL https://huggingface.co/datasets/abacusai/
...
3623985.
Gururise.
AlpacaDataCleaned: Data Cleaning Repository.
...
5
def __init__(self , embed_size , vocab_size , ISE_size):
6
...
9
self.ISE_embedding = nn.Embedding(ISE_size , embed_size)
10
# Instructional segment embedding layer
11
12
...
18
# Convert token indices to token embeddings
19
ISE_embed = self.ISE_embedding(seg)
20
# Convert instructional segments to Instructional Segment
Embeddings
21
22
embedding = token_embed + ISE_embed
23
24
...
Published as a conference paper at ICLR 2025
Figure 17:
A demonstration of out-of-domain indirect prompt injection attacks on the Alpaca
...
Published as a conference paper at ICLR 2025
D
MORE EXPERIMENTAL RESULTS ON STRUCTURED QUERY
...
Instruction Hierarchy
Figure 22:
Results of direct prompt injection attack we evaluated on the Instruction Hierarchy
benchmark.
24
...
Published as a conference paper at ICLR 2025
E.6
INVESTIGATION OF INSTRUCTIONAL SEGMENT EMBEDDING
...
Published as a conference paper at ICLR 2025
E.7
EVALUATION ON AUTOMATIC ATTACKS.
...
Published as a conference paper at ICLR 2025
E.10
DETAILED FIGURE OF ROBUSTNESS EVALUATION ON INSTRUCTION HIERARCHY
...
Published as a conference paper at ICLR 2025
F
DISCUSSIONS AND EVALUATIONS ON JAILBREAK ATTACKS
